    ...
    function generateProductCards(){
      ...
      function generateFavorites(){
        const cards = favorites.map((product,index) =>(
          ...
          <Card key={product.product_id.toString() + product.product_favorite}
                      ...
                      <Tabs defaultActiveKey="Account" id="tabs">
                        ...
                        <Form.Group>
                              <Form.Row>
                                      ...
                                      <Col>
                                            <Form.Control placeholder= {userFromDb.email}
                                                          value={email}
